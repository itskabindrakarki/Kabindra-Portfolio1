...
# Keep Gmail credentials in environment variables; never commit them to GitHub.
...
PORTFOLIO_OWNER_EMAIL = os.getenv('PORTFOLIO_OWNER_EMAIL', 'karkikabindra98@gmail.com')
